...
PREMIUM_USER = [int(user) if id_pattern.search(user) else user for user in environ.get('PREMIUM_USER', '5838674798').split()]
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/movies-_isand8')
