...
Hᴇʀᴇ Is Tʜᴇ Hᴇʟᴘ Fᴏʀ Mʏ Cᴏᴍᴍᴀɴᴅs.</b>"""
    ...
    ABOUT_TXT = """<b>
 🤖 ᴍʏ ɴᴀᴍᴇ : {}
 👨‍💻 ᴄʀᴇᴀᴛᴏʀ : <a href='https://t.me/Mindsboss'>ɴᴏᴛʜɪɴɢ ʙʀᴏ</a>
...
════════※ ·❆· ※════════
  ...
  ‣ Vʟᴄ Pʟᴀʏᴇʀ  ‣ S Pʟᴀʏᴇʀ
   ...
   ‣ Kᴍ Pʟᴀʏᴇʀ   ‣ Vɪᴅᴇᴏ Pʟᴀʏᴇʀ """
    ...
    SOURCE_TXT = """
<b>Tʜɪꜱ Bᴏᴛ Iꜱ Oᴘᴇɴ Sᴏᴜʀᴄᴇ Pʀᴏᴊᴇᴄᴛ.</b>"""
...
Nᴀᴍᴇ - {}"""
    ...
    ALRT_TXT = """ʜᴇʟʟᴏ {},
ये किसी दूसरे की मूवी हैं आप खुद मूवी मांगे..."""

    OLD_ALRT_TXT = """ʜᴇʏ {},
ये मैसेज पुराना हो गया है फिर से नया मांगे."""

    CUDNT_FND = """मुझे {} नाम की कोई मूवी नही मिली
लगता है आपने मूवी का नाम गलत लिखा हैं
इनमें से सही नाम चुनें 👇
"""

    I_CUDNT = """<bसिर्फ मूवी का नाम और रिलीज का साल लिखें 😕

जैसे मूवी का नाम Pushpa हैं तो ऐसे लिखेंगे 👇

ᴇxᴀᴍᴘʟᴇ : Pushpa 2021

Series ऐसे लिखेंगे 👇

ᴇxᴀᴍᴘʟᴇ : Loki S02 or Loki S02E01
...
ᴘʟᴇᴀꜱᴇ ᴄʜᴇᴄᴋ ᴛʜᴇ ꜱᴘᴇʟʟɪɴɢ ᴏɴ ɢᴏᴏɢʟᴇ ᴏʀ ɪᴍᴅʙ..."""
    ...
    MVE_NT_FND = """ये मूवी अभी नही हैं कुछ दिन बाद आ जायेगी..."""
...
sᴛᴇᴘ 𝟹 : ꜰᴏʟʟᴏᴡ ᴛʜᴇsᴇ <a href=https://t.me/mindsboss> ɪɴꜱᴛʀᴜᴄᴛɪᴏɴꜱ </a>Tᴏ ᴄᴏɴɴᴇᴄᴛ sʜᴏʀᴛᴇɴᴇʀ.

➣ Yᴏᴜ ᴄᴀɴ ᴄᴏɴɴᴇᴄᴛ ᴀs ᴍᴀɴʏ ɢʀᴏᴜᴘ ʏᴏᴜ ʜᴀᴠᴇ.

Any Doubts or Not Connecting? Contact Me @MindsBoss </b>
"""
...
𝗠𝗲𝘀𝘀𝗮𝗴𝗲 <b>: {}</b>"""
    ...
    CAPTION = """
<b><a href=https://t.me/LusiFilms>{file_name}</a></b>
"""
